        ...
        <div className='row'>
            ...
            <div className="col-8 col-md-6 m-auto " key={patient.id}>
                <div className={`card  p-4 x mb-2`} key={patient.id} style={{ borderRadius: 0, height: "300px" }}>
                    <img src={'https://dresden-handchirurgie.de/wp-content/uploads/2016/09/profile_placeholder-1024x1024.png'} className="card-img-top m-2 p-2 m-auto" style={{ height: "100px", width: "75%", marginTop: "5%" }} alt="..." />
            ...
            <div className='row m-2 p-2'>
                <button type="button" style={{ borderRadius: "0px" }} onClick={() => navigate('/')} className=' col-12 col-md-12 m-auto  btn btn-primary btn-md m-auto '>Back</button>
            </div>
        </div>
        </div>
    )
